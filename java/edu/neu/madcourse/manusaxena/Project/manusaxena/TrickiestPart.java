package edu.neu.madcourse.manusaxena.Project.manusaxena;
...
public class TrickiestPart extends AppCompatActivity implements EasyPermissions.PermissionCallbacks,
    ...
    private GoogleApiClient mGoogleApiClientSignIn,mGoogleApiClientLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityLayout.addView(tvlocation);
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            TrickiestPart.REQUEST_AUTHORIZATION);
                } else {
    ...
    protected void onStop() {
        super.onStop();
        if (mGoogleApiClientSignIn.isConnected()) {
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        try
        {
            ...
            if (mLastLocation != null) {
                ...
                tvlocation.setText("Your current location coordinates are:     "+String.valueOf(mLastLocation.getLatitude())+String.valueOf(mLastLocation.getLongitude())+"\n");
