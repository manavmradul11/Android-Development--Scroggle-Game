...
import edu.neu.madcourse.manusaxena.Assignment5.WordGameActivity;
...
public class CommunicationMainFragment extends Fragment {
   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View rootView =
            inflater.inflate(R.layout.fragment_communication_main, container, false);
      // Handle buttons here...
      View newButton = rootView.findViewById(R.id.two_p_word_game_new_button);
      View newMultiplayerButton = rootView.findViewById(R.id.two_p_word_game_new_multiplayer_button);
      View continueButton = rootView.findViewById(R.id.two_p_word_game_continue_button);
